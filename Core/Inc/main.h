...
#define USART2_PREEMPT_PRIORITY 3
#define USART2_SUB_PRIORITY 0
#define USART2_PULL_MODE GPIO_PULLUP
...
#define CAN1_TX_IT_PREEMPT_PRIORITY 3
#define CAN1_TX_IT_SUB_PRIORITY 1
#define CAN1_RX_IT_PREEMPT_PRIORITY 3
#define CAN1_RX_IT_SUB_PRIORITY 0

#define CAN2_MASK_ID   0x7f0
#define CAN2_FILTER_ID  0x200
#define CAN2_IT_TYPE CAN_IT_RX_FIFO1_MSG_PENDING
#define CAN2_MAIL_BOX CAN_TX_MAILBOX1
#define CAN2_FIFO CAN_RX_FIFO1
#define CAN2_FILTER_INDEX 14
#define CAN2_TX_IT_PREEMPT_PRIORITY 3
#define CAN2_TX_IT_SUB_PRIORITY 1
#define CAN2_RX_IT_PREEMPT_PRIORITY 3
#define CAN2_RX_IT_SUB_PRIORITY 0
